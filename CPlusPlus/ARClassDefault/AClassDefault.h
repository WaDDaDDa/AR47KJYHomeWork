...
{
public:
    AClassDefault(int Value) {} // 디폴트 생성자.
    ~AClassDefault() {} // 디폴트 소멸자

    AClassDefault& operator=(const AClassDefault& _Other) = delete; // 디폴트 대입 연산자
    AClassDefault& operator=(const AClassDefault&& _Other) = delete; // 디폴트 대입 연산자
    AClassDefault(const AClassDefault& _Other) = delete; // 디폴트 복사 생성자
    AClassDefault(const AClassDefault&& _Other) = delete; // RValue 복사 생성자
